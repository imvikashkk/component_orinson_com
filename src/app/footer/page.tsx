  ...
  return (
    <footer className="pt-12 footer-bg relative">
      <div className="mx-auto max-w-7xl p-6 lg:px-8">
        ...
        <div className="flex flex-1">
          <Link href="https://orinson.com/" className="-m-1.5 p-1.5 flex gap-[6px] no-select">
            <Image
              ...
              height={70}
            />
            <span className={`flex flex-col justify-center items-center no-select gradient-text-logo-blue
              ${teko.className}`}>
        ...
        <p className="text-base mt-4 text-slate-200 hover:text-white transition-all duration-300">At Orinson Technologies Private Limited, we deliver cutting-edge web and app solutions. Our digital marketing team enhances your brand, while our video editors and graphic designers create stunning visuals and engaging content. Transform your ideas into impactful digital experiences with our comprehensive services.</p>
        </div>
          <div className="mx-auto text-center md:text-start">
              ...
              <ul className="list-inside list-none">
                ...
                <li className="my-5 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://certify.orinson.com/" target="_blank">Certification</Link>
                </li>
              </ul>
            </div>
          <div className="mx-auto text-center md:text-start">
              ...
              <ul className="list-inside list-none">
                <li className="my-2 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://orinson.com/services/web-app-development">Web & App Development</Link>
                </li>
                <li className="my-2 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://orinson.com/services/digital-marketing">Digital Marketing</Link>
                </li>
                <li className="my-2 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://orinson.com/services/videoediting-graphicdesign">VideoEditing | GraphicDesign</Link>
                </li>
                <li className="my-2 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://orinson.com/services/content-management-marketing">Content Management & Marketing</Link>
                </li>
                <li className="my-2 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://orinson.com/services/paid-campaign">Paid Campaign</Link>
                </li>
                <li className="my-2 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://orinson.com/services/website-optimization">Website Optimization</Link>
                </li>
                <li className="my-2 text-sm text-slate-200 hover:text-white transition-all duration-300">
                  <Link href="https://orinson.com/services/software-development">Other Software Service</Link>
                </li>
              </ul>
            </div>
